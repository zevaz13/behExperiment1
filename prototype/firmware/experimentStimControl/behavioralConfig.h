...
// Default values for the behavioral experiment's runtime-configurable
// settings (see behavioralSettings.h). Flicker: amber is always on, red+green
// are knob-controlled, both as independent square waves at the same
// frequency, 50% duty cycle.
constexpr unsigned int kBehavioralFlickerFrequencyHz = 10;
constexpr unsigned int kBehavioralAmberValue         = 2400;
constexpr unsigned int kBehavioralMaxRed             = 3000;
constexpr unsigned int kBehavioralMaxGreen           = 2400;
constexpr unsigned int kBehavioralMinRed             = 0;
constexpr unsigned int kBehavioralMinGreen           = 0;
